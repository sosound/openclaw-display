...
SIGHT_POND_DIR = os.path.join(WORKSPACE, "sight-pond")
TEMPLATES_DIR = os.path.join(SIGHT_POND_DIR, "templates")
STATIC_DIR = os.path.join(SIGHT_POND_DIR, "static")
IMAGES_DIR = os.path.join(SIGHT_POND_DIR, "images")
...
SSL_CERTS = [
    {"domain": "galaxystream.online", "valid_until": "2026-06-03", "days_left": 89},
    {"domain": "diary.galaxystream.online", "valid_until": "2026-06-03", "days_left": 89},
    {"domain": "show.galaxystream.online", "valid_until": "2026-06-03", "days_left": 89},
]

# ==================== 最后更新时间 ====================

LAST_UPDATE = "2026-03-05 15:12"
